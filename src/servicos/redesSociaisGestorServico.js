...
export async function buscarRedesSociaisGestor() {
  ...
  return requestAutenticada("/v1/gestor-rede/dev/redes/redes-sociais", { method: "GET" });
}
...
export async function salvarRedesSociaisGestor(body) {
  ...
  return requestAutenticada("/v1/gestor-rede/dev/redes/redes-sociais", {
    method: "PATCH",
